...
application.add_handler(staff_phone)
application.add_handler(stu_phone)
application.add_handler(tch_phone)
application.add_handler(asg_phone)
application.add_handler(exam_phone)
...
application.add_handler(MessageHandler(filters.Regex("^📊 ሪፖርቶች$"), reports_menu))
application.add_handler(MessageHandler(filters.Regex("^👤 የኔ መረጃ$"), my_info))
application.add_handler(MessageHandler(filters.Regex("^ℹ️ ስለ ትምህርት ቤቱ$"), about))
